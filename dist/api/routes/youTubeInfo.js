...
const youTubeInfo_model_1 = require("../models/youTubeInfo.model");
...
router.post('/', (req, res, next) => {
    ...
    if (myArray) {
        ...
        request.get(ytRequestURL, (err, response, body) => {
            if (err) {
                res.status(500).json({
                    error: err
                });
                ...
                let youTubeInfo = new youTubeInfo_model_1.YouTubeInfoModel();
...
//# sourceMappingURL=youTubeInfo.js.map